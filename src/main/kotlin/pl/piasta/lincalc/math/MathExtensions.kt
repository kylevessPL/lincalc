...
object MathExtensions {
    ...
    fun BigDecimal.sqrt(): BigDecimal = createLocalMathContext(PRECISION).use {
        sqrt(this)
    }

    fun BigDecimal.sin(): BigDecimal = createLocalMathContext(PRECISION).use {
        sin(this)
    }

    fun BigDecimal.cos(): BigDecimal = createLocalMathContext(PRECISION).use {
        cos(this)
    }
}
